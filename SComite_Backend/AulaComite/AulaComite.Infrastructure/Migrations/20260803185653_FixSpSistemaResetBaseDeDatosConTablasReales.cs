...
{
    /// <inheritdoc />
    public partial class FixSpSistemaResetBaseDeDatosConTablasReales : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            // 🚀 suppressTransaction: true permite que el comando BACKUP DATABASE se ejecute en SQL Server sin fallar
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    BEGIN TRY
                        ...
                        -- Eliminar registros de tus 13 tablas transaccionales
