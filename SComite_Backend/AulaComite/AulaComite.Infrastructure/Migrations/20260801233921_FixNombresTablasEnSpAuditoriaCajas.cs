...
{
    /// <inheritdoc />
    public partial class FixNombresTablasEnSpAuditoriaCajas : Migration
    {
        /// <inheritdoc />
            ...
            migrationBuilder.Sql(@"
                ...
                BEGIN
                    ...
                    WITH IngresosCuotas AS (
                        -- 1. Suma de Pagos de Cuotas Validados por Estudiante/Aula
                        SELECT 
                            a.Id AS AulaId,
                    ...
                    IngresosDonaciones AS (
                        -- 2. Suma de Donaciones Registradas
                        SELECT 
                            a.Id AS AulaId,
